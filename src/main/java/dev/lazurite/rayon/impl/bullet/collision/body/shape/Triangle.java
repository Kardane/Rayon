...
public class Triangle {
    ...
    public static List<Triangle> getMeshOf(VoxelShape voxelShape) {
        ...
        return getMeshOfBoxes(voxelShape.toAabbs());
    }

    public static List<Triangle> getMeshOfBoxes(List<net.minecraft.world.phys.AABB> boxes) {
        var vec = new Vector3f();
        final var triangles = new ArrayList<Triangle>(6 * 2 * boxes.size());
